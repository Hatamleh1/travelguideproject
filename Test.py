...
class hotels(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def display():
            if o1.get() == "5":
                hotels_r['Wellington'] = str(o1.get())
                r = hotels_r['Wellington']
                tk.Label(self, text=r).place(relx=0.82, rely=0.35, anchor=W)
            if o1.get() == "4":
                hotels_r['Wellington'] = str(o1.get())
                r = hotels_r['Wellington']
                tk.Label(self, text=r).place(relx=0.82, rely=0.35, anchor=W)
            ...
            if o3.get() == "5":
                ...
                hotels_r['Ibbys_hotel'] = str(o3.get())
            if o3.get() == "4":
                tk.Label(self).place(relx=0.82, rely=0.55, anchor=W)
                hotels_r['Ibbys_hotel'] = str(o3.get())
            if o3.get() == "3":
            ...
            if o4.get() == "5":
                ...
                hotels_r['Yellow_hotel'] = str(o4.get())
            if o4.get() == "4":
                tk.Label(self).place(relx=0.82, rely=0.65, anchor=W)
                hotels_r['Yellow_hotel'] = str(o4.get())
            if o4.get() == "3":
        ...
        button1 = tk.Button(self, text="submit", command=lambda: display(), highlightbackground='light grey')
