...
class TravelguideApp(Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (main_page, holland, spain, germany, UK, france, LoginPage, SignupPage, about_holland, best_visit, currency, electricity, transport, city, amsterdam_nav, gudie_info_ams, hotels_ams, hotels_haag, haag_nav, hotels_rot, rotterdam_nav, gudie_info_rot, gudie_info_haag, restaurants, sightseeing, activities, Restaurants_ams):
